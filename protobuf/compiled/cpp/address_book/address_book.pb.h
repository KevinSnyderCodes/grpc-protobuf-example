...
#ifndef PROTOBUF_INCLUDED_address_5fbook_2faddress_5fbook_2eproto
#define PROTOBUF_INCLUDED_address_5fbook_2faddress_5fbook_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_address_5fbook_2faddress_5fbook_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_address_5fbook_2faddress_5fbook_2eproto {
...
template<> ::Person_TagsEntry_DoNotUse* Arena::CreateMaybeMessage<::Person_TagsEntry_DoNotUse>(Arena*);
...
class Person_TagsEntry_DoNotUse : public ::google::protobuf::internal::MapEntry<Person_TagsEntry_DoNotUse, 
...
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
  typedef ::google::protobuf::internal::MapEntry<Person_TagsEntry_DoNotUse, 
    ::std::string, ::std::string,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    0 > SuperType;
  Person_TagsEntry_DoNotUse();
  Person_TagsEntry_DoNotUse(::google::protobuf::Arena* arena);
...
class Person : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Person) */ {
 public:
  ...
  static const int kIsBlockedFieldNumber = 6;
...
Person::tags() const {
  // @@protoc_insertion_point(field_map:Person.tags)
  return tags_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
Person::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_map:Person.tags)
  return tags_.MutableMap();
}

// bool isBlocked = 6;
inline void Person::clear_isblocked() {
  isblocked_ = false;
}
inline bool Person::isblocked() const {
  // @@protoc_insertion_point(field_get:Person.isBlocked)
  return isblocked_;
}
inline void Person::set_isblocked(bool value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_address_5fbook_2faddress_5fbook_2eproto
